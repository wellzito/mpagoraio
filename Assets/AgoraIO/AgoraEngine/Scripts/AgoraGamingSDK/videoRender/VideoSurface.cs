    ...
    */
    ...
    public class VideoSurface : MonoBehaviour
    {
        ...
        void OnDestroy()
        {
            ...
            Debug.Log($"Destroying VideoSurface {transform.parent}");
        ...
        */
        public void SetForUser(uint uid)
        {
            ...
            {
                mUid = uid;
                Debug.Log($"VideoSurface {gameObject.name} | UID {uid}");
        ...
        * - false: (Default) Disable.
        */
        public void EnableFlipTextureApplyX(bool enableFlipHorizontal)
        {
            Vector3 newScale = transform.localScale;

            // Flip horizontal
            if (enableFlipHorizontal)
            {
            ...
            // Atualizar os flags de controle
            _enableFlipHorizontal = enableFlipHorizontal;
        }
        public void EnableFlipTextureApplyY( bool enableFlipVertical)
        {
            Vector3 newScale = transform.localScale;
            // Flip vertical
            if (enableFlipVertical)
            {
        ...
        */
        ...
        public void AddUserInfo(uint uid)
        {
            videoRender.AddUserVideoInfo(uid, 0);
        }
        public void RemoveUserInfo(uint uid)
        {
            videoRender.RemoveUserVideoInfo(uid);
        }
